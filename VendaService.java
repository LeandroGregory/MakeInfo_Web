...
public class VendaService {
    ...
    public Venda registrarVendaComItens(Venda venda, List<ItemVenda> itens) {
        ...
        venda.setTotalVenda(calcularTotalItens(itens));
    ...
    /**
     * Calcula o valor total de uma venda a partir da lista de itens
       (quantidade x valor unitário de cada item).
     */
    public double calcularTotalItens(List<ItemVenda> itens) {
